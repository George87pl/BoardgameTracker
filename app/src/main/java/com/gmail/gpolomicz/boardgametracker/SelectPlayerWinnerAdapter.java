...
public class SelectPlayerWinnerAdapter extends ArrayAdapter {
    ...
    SelectPlayerWinnerAdapter(Context context, int resource, List<PlayerEntry> playerEntry) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (playerEntry.get(position).isWinner()) {

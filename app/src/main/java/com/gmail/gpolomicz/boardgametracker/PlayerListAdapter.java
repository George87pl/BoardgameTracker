...
public class PlayerListAdapter extends ArrayAdapter {
    ...
    PlayerListAdapter(Context context, int resource, List<PlayerEntry> playerEntry) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (currentInfo.getNote() != null) {
            viewHolder.note.setText(currentInfo.getNote());
        }

        if(currentInfo.isWinner()) {
            viewHolder.winner.setImageResource(R.drawable.winner);
    ...
    private class ViewHolder {
        ...
        ViewHolder(View v) {
            ...
            this.note = v.findViewById(R.id.player_note);
            this.winner = v.findViewById(R.id.checkBox);
